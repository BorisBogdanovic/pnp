        ...
        <table style="max-width: 740px; width: 100%; margin: 50px 0">
            ...
            <tr style="">
                <td style="background-color: #F9FAFB; height: 94px; padding: 10px;">
                    <div style="padding:32px">
                        ...
                        <img height="40px" src="{{ asset('db-image/logo.png') }}" alt="Logo">
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding: 48px 56px;">
                    <h1 class="email-heading mb-32">Zdravo {{$invite->name}} {{$invite->last_name}}</h1>
                    <p class="email-paragraph mb-32">Pozvani ste da se registrujete na našu platformu. Možete se registrovati putem linka koji ste dobili u ovom mejlu. </p>
                    <div>
                        <p class="email-paragraph">Link za registraciju:</p>
                        <div class="mb-32" style="border:1px solid #D0D5DD; border-radius: 4px; padding: 16px; ">
                            <table>
                                <tr>
                                    <td>
                                        <img width="48" src="{{ asset('db-image/link.svg') }}" alt="Link">
                                    </td>
                                    <td>
                ...
                <tr style="">
                    <td style="background-color: #F9FAFB; height: 94px; padding: 10px;">
                        <div style="padding:32px; color: #98A2B3;font-size: 14px; font-weight: 500; line-height: 20px;">
                            ...
                            <p class="paragraph">SrbijaTel: (381 11) 1111 111, 1111 111</p>
